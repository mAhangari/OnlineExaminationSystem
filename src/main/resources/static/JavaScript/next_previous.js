    ...
    $.fn.next_func = function () {
        ...
        if ($end < res_length) {
            ...
            if (circle_id === 0 && (res_length / $rowPerPage) <= 2) {
                ...
                $(`#circle_id_${circle_id + 2}`).css("backgroundColor", "white").addClass("middle_circle").removeClass("litle_circle");
                circle_id++;
                ...
                $(`#circle_id_${circle_id}`).css("backgroundColor", "white").addClass("middle_circle").removeClass("circle");
                $(`#circle_id_${circle_id - 1}`).addClass("litle_circle").removeClass("middle_circle");
                $(`#circle_id_${circle_id + 1}`).addClass("circle").removeClass("middle_circle").css("backgroundColor", "gray");
                circle_id++;
                ...
                $(`#circle_id_${circle_id - 1}`).addClass("litle_circle").removeClass("middle_circle");
                $(`#circle_id_${circle_id + 1}`).addClass("circle").removeClass("middle_circle").css("backgroundColor", "gray");
                $(`#circle_id_${circle_id + 2}`).addClass("middle_circle").removeClass("litle_circle");
                circle_id++;
    ...
    $.fn.next_previous_button = function () {
        ...
        if ($end < res_length) {
            ...
            if ((res_length / $rowPerPage) <= 2) {
                ...
                tr.push($(`<span id="circle_id_${i++}" class='middle_circle'>`)[0]);
                tr.push($(`<span id="circle_id_${i++}" class='litle_circle'>`)[0]);
            }

            if ((res_length / $rowPerPage) > 3 && (res_length / $rowPerPage) <= 4) {
                tr.push($(`<span id="circle_id_${i++}" class='litle_circle display_none'>`)[0]);
